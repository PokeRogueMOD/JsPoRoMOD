...
export function initPopup() {
  ...
  actionToggle.addEventListener('click', () => {
    ...
    actionToggle.innerHTML = featureButtons.classList.contains('active') ? '<span class="material-icons-outlined">chevron_left</span>' : '<span class="material-icons-outlined">chevron_right</span>';
  });

  socialToggle.addEventListener('click', () => {
    socialLinks.classList.toggle('active');
    socialToggle.innerHTML = socialLinks.classList.contains('active') ? '<span class="material-icons-outlined">keyboard_arrow_up</span>' : '<span class="material-icons-outlined">keyboard_arrow_down</span>';
  });
